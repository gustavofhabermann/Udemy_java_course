...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Order o1 = new Order(null, Instant.parse("2026-06-16T15:15:10Z"), u1);
        Order o2 = new Order(null, Instant.parse("2026-06-16T15:15:20Z"), u1);
        Order o3 = new Order(null, Instant.parse("2026-06-16T15:15:30Z"), u2);
        Order o4 = new Order(null, Instant.parse("2026-06-16T15:15:40Z"), u2);
